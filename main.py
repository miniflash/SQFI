...
if __name__ == '__main__':
    ...
    #data
    parser.add_argument('--phase', type=str, default='pretrain', choices=['pretrain', 'intermptitrain', 'intermptieval'])
    ...
    # Start trainer for pre-train, intermpti-train, intermpti-eval
    if args.phase=='intermptitrain':
        args.log_dir = args.save_path + 'log_intermpti_%s_S%d_N%d_K%d_Att%d' % (args.dataset, args.cvfold,
                                                                             args.n_way, args.k_shot,
                                                                             args.use_attention)
        from runs.train import train
        train(args)
    elif args.phase=='intermptieval':
